...
コンベアベルト運搬量 = {"コンベアベルトMk1":60, "コンベアベルトMk2":120, "コンベアベルトMk3":270, "コンベアベルトMk4":480, "コンベアベルトMk5":780}
コンベアベルトMk1運搬量,コンベアベルトMk2運搬量,コンベアベルトMk3運搬量,コンベアベルトMk4運搬量,コンベアベルトMk5運搬量 = コンベアベルト運搬量["コンベアベルトMk1"], コンベアベルト運搬量["コンベアベルトMk2"], コンベアベルト運搬量["コンベアベルトMk3"], コンベアベルト運搬量["コンベアベルトMk4"], コンベアベルト運搬量["コンベアベルトMk5"]
コンベアベルト = ("コンベアベルトMk1","コンベアベルトMk2","コンベアベルトMk3","コンベアベルトMk4","コンベアベルトMk5")
...
if not 0.0000 <= OCrate <= 250.0000:
    ...
    if minerSUM <= 0:
        ...
        print("780/mを超えたため、コンベアベルトMk5で780/mのレートで運搬可能、["+str(Over_rateSUM)+"/m]の過剰生産です")
